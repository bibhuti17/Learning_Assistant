...
const SignIn = () => {
  ...
  // to verify from database and login
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }} >
      ...
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000028] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
        ...
        <p className='text-white text-[18px] cursor-pointer' onClick={() => navigate("/signup")}>Go ahead and create an account ?
