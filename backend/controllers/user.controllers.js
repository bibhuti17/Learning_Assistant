...
export const getCurrentUser = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Internal Server Error getCurrentUser()" })
    }
}
...
export const updateAssistant = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Internal Server Error updateAssistant()" })
    }
}
...
export const askToAssistant = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: "Internal Server Error askToAssistant()" })
    }
}